...
Movie.all.each do |movie|
  Bookmark.create!(comment: Faker::Lorem.sentence, movie: movie, list: all_list)
end

super_hero_list = List.create!(name: 'SuperHero')
Bookmark.create!(comment: 'ok movie', movie: wonder_woman, list: super_hero_list)
